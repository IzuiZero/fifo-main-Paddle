...
class TripletMarginLoss(BaseMetricLossFunction):
    ...
    def compute_loss(self, embeddings, labels, indices_tuple):
        ...
        ap_dists = mat.numpy()[anchor_idx, positive_idx]  # Convert to numpy to extract values
        an_dists = mat.numpy()[anchor_idx, negative_idx]

        if self.swap:
            pn_dists = mat.numpy()[positive_idx, negative_idx]
            an_dists = paddle.minimum(an_dists, pn_dists)
